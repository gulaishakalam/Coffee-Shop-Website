...
<div>
    <div class="wrapper">
        <h1 style="color: #3e3d3d">Update Admin</h1>
        <br><br>
...
if(isset($_POST['submit']))
{
    ...
    if($res==TRUE)
    {
        $_SESSION['update']="<div style='color:blue;'>Admin updated successfully</div>";
        header('location:'.SITEURL.'admin/manage-admin.php');
    }
    else
    {
        $_SESSION['update']="<div style='color:red;'>Admin not updated</div>";
        header('location:'.SITEURL.'admin/manage-admin.php');
    }
}
